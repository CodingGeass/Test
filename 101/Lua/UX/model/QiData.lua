if QiData==nil then 
    ...
    QiData.PropertySchinese={
        ...
        HpRegenRatePercentAdd="全局每秒生命恢复<color=#ffff33>百分比增加</color>",
        PhysicalLifeStealPercentAdd="全局物理生命汲取<color=#ffff33>百分比增加</color>",
        ...
        HpRegenRateKillAdd="<color=#0099ff>击败增加</color>生命恢复",
        PhysicalLifeStealKillAdd="<color=#0099ff>击败增加</color>物理生命汲取",
        ...
        HpRegenRateSecAdd="<color=#00ff55>每秒</color>生命恢复增加",
        PhysicalLifeStealSecAdd="<color=#00ff55>每秒</color>物理生命汲取增加",
