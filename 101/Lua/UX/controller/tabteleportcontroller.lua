if tabteleportcontroller==nil then 
    tabteleportcontroller={}
    ...
    tabteleportcontroller.area["b_liangong"]={
        pos="liangong",
    ...
    tabteleportcontroller.area["n2_jiulong"]={
        pos="n2_jiulong",
    ...
    tabteleportcontroller.area["n3_jifeng"]={
        pos="n3_jifeng",
    ...
    tabteleportcontroller.area["n12_youjie"]={
        pos="n12_youjie",
    ...
    tabteleportcontroller.area["s1_yaota1"]={
        pos="s1_yaota",
    ...
    tabteleportcontroller.area["s2_boss"]={
        pos="s2_boss",
        schinese="<color=#ff1a1a>幽界之井</color>",
        description="",
        Tier=12,
...
function tabteleportcontroller:init()
end

-- 传送到
function tabteleportcontroller:teleportto(e_name)
    local message = {e_name=e_name}
    message.fnam = "teleport"
    message.aid=LuaCallCs_Battle.GetHostActorID();
