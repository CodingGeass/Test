...
function OnStartupOpen(luaUIEvent)
	...
	l_heroid:SetInputContent(105);--廉颇
	
	l_heroiddrop:SetDropTextContents(1163);
...
function OnLevelDropChange(luaUIEvent)
	...
	G_CommonData.levelName = dropp:GetItemText():GetContent()
	operatData = json.encode(G_CommonData)
	LuaCallCs_UGCStateDriver.SendCommonCustomOperation(operatData)
end
